# Generated by Django 3.1.4 on 2020-12-11 08:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('budgettype', models.CharField(choices=[(None, 'Код не найден'), ('00', 'Прочие бюджеты'), ('01', 'Федеральный бюджет'), ('02', 'Бюджет субъекта РФ'), ('03', 'Бюджеты внутригородских МО г. Москвы и г. Санкт-Петербурга'), ('04', 'Бюджет городского округа'), ('05', 'Бюджет муниципального района'), ('06', 'Бюджет Пенсионного фонда РФ'), ('07', 'Бюджет ФСС РФ'), ('08', 'Бюджет ФФОМС'), ('09', 'Бюджет ТФОМС'), ('10', 'Бюджет поселения'), ('98', 'Распределяемый доход'), ('99', 'Доход организации (только для ПДИ)')], default='00', max_length=2, verbose_name='Тип бюджета')),
                ('oktmocode', models.CharField(default='0', max_length=11, verbose_name='код ОКТМО')),
                ('parentcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='Budgets.budget', verbose_name='Вышестоящий бюджет')),
            ],
            options={
